...
const strings = (stringa1, stringa2) => {
  const parte1 = stringa1.slice(0, 2)
  const parte2 = stringa2.slice(-3)
  const result = (parte1 + parte2).toUpperCase()

  console.log(result)
}

console.log(strings("mario", "michele"))
...
const sumReduce = (sum2) => {
  return sum2.reduce((sommaParziale, numero) => sommaParziale + numero + 0)
}
...
let n = 4
const incrementalNumber = numbers.map((num) => num + n)
...
const stringa = ["Forza", "Napoli", "sempre"]

console.log(arrayNumber(stringa))
